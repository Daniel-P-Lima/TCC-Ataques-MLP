...
{
    const std::string FILE_PATH{BIN_TREES_PATH + std::to_string(file_index) + FILE_EXTENSION};
    ...
    file.read(reinterpret_cast<char*>(arena), sizeof(Node) * node_count);
...
std::vector<Instance> fitMany(const char* filename)
{
...
int main(int argc, char *argv[])
{
    ...
    arena = static_cast<Node*>(std::malloc(ARENA_SIZE));
